...
export const content: Routes = [
  {
    path: 'general-info',
    loadChildren: () => import('../../components/general-info/general-info.module').then(m => m.GeneralInfoModule),
    data: {
      breadcrumb: "Widgets"
    }
  },
  {
    path: 'members',
    loadChildren: () => import('../../components/member/members.module').then(m => m.MembersModule),
    data: {
      breadcrumb: "Users"
    }
  },
  {
    path: 'admins',
    loadChildren: () => import('../../components/admin/admins.module').then(m => m.AdminsModule),
    data: {
      breadcrumb: "Users"
    }
  },
