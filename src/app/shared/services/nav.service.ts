...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{
			path: '/general-info', title: 'Tableau de bord', icon: 'settings', type: 'link'
		},
		{
			path: '/members/members', title: 'Gestion des membres', icon: 'settings', type: 'link'
		},
		{
			path: '/admins/admins', title: 'Administration', icon: 'settings', type: 'link'
		},
		{
			path: '/general-info', title: 'Informations générales', icon: 'settings', type: 'link'
		},
		{
